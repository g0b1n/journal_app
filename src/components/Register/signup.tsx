    ...
    return (
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                >
                    <div>
                        ...
                        <div>
                            <div>
                                ...
                                >
                                    Phone{" "}
                                    <span className="text-xs text-thin text-gray-500">
                                        Optional
                                    </span>
                                </label>
                            </div>
                    ...
                    <div>
                        ...
                        <div className="mt-1 text-xs font-light text-gray-500">
                            <p>
                                Must contain: Min 8 Characters, 1 uppercase, 1
                ...
                {/* Registration success message before redirecting to main page  */}
                {error && (
                    <p className="mt-2 text-center text-green-500">{error}</p>
                )}
